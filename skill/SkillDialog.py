...
class SkillDialog(QDialog):
    ...
    def setupUi(self):
        ...
        self.buttonBox.accepted.connect(self.add_skill) # type: ignore
    ...
    def retranslateUi(self, Dialog):
        ...
        self.sort_label.setText(_translate("Dialog", "章节"))
...
# 显示在线图片
    ...
    def add_skill(self):
        ...
        data["chapterId"] = int(self.sort_lineEdit.text())
        if self.image_src:
            data["imageSrc"]=self.image_src
            # RequestTools.post_method(PathConstant.ADD_STEP, data)
            HttpTool.post(PathConstant.POST_SKILL, data)
        self.accept()