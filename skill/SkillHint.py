...
from skill.SkillQuestion2SearchDialog import SkillRelQuetion2Dialog
from skill.SkillRelQuetionDialog import SkillRelQuetionDialog
from skill.SkillStepSearchDialog import SkillStepSearchDialog


class SkillHint(QWidget):
    ...
    def __init__(self, skill_id):
        ...
        # self.hint=HttpTool.get(PathConstant.QUERY_HINT + str(skill_id))
    ...
    def add_rel_step(self):
        ...
        dialog=SkillStepSearchDialog(self.skill_id)
        dialog.exec_()

    def add_rel_question(self):
        dialog=SkillRelQuetion2Dialog(self.skill_id)
        dialog.exec_()
